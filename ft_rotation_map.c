...
void	ft_rotate_x(t_env *env_ptr)
{
	...
	while (i < size)
	{
		...
		env_ptr->double_coord_tab[i].y = coord_i.y * cos(theta) + coord_i.z * sin(theta) + env_ptr->origin.y;
		env_ptr->double_coord_tab[i].z = -coord_i.y * sin(theta) + coord_i.z * cos(theta) + env_ptr->origin.z;
		i++;
	}
}
...
void	ft_rotate_y(t_env *env_ptr)
{
	...
	while (i < size)
	{
		...
		coord_i.y = env_ptr->double_coord_tab[i].y - env_ptr->origin.y;
		coord_i.z = env_ptr->double_coord_tab[i].z - env_ptr->origin.z;
		env_ptr->double_coord_tab[i].x = coord_i.x * cos(theta) - coord_i.z * sin(theta) + env_ptr->origin.x;
		env_ptr->double_coord_tab[i].z = coord_i.x * sin(theta) + coord_i.z * cos(theta) + env_ptr->origin.z;
		i++;
	}
}
...
void	ft_rotate_z(t_env *env_ptr)
{
	...
	while (i < size)
	{
		...
		coord_i.y = env_ptr->double_coord_tab[i].y - env_ptr->origin.y;
		coord_i.z = env_ptr->double_coord_tab[i].z - env_ptr->origin.z;
		env_ptr->double_coord_tab[i].x = coord_i.x * cos(theta) + coord_i.y * sin(theta) + env_ptr->origin.x;
		env_ptr->double_coord_tab[i].y = -coord_i.x * sin(theta) + coord_i.y * cos(theta) + env_ptr->origin.y;
		i++;
