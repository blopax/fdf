...
void    ft_transfo_iso(t_env *env_ptr, int i)
{
	...
	env_ptr->double_coord_tab[i].Y_proj = -env_ptr->double_coord_tab[i].z - env_ptr->param.iso_cte1 / 2 * env_ptr->double_coord_tab[i].x + env_ptr->param.iso_cte2 / 2 + env_ptr->double_coord_tab[i].y;
}
